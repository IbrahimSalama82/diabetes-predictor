...
texts = {
    "English": {
        ...
        "explanation": "Model Explanation (SHAP)",
    ...
    "العربية": {
        ...
        "predict": "تنبؤ",
        "result": "نتيجة التنبؤ",
        "probability": "احتمال الإصابة بالسكري",
        "explanation": "شرح قرار النموذج (SHAP)",
...
if st.button(t["predict"]):
    ...
    st.success(t["result_1"] if prediction == 1 else t["result_0"])

    st.subheader(t["probability"])
